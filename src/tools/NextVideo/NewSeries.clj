...
(defn main2 []
  ...
  (createYAMLfromTVHOMEUrl "HALT",2,"TVHOME_RAW/halt2.html")
  (createYAMLfromTVHOMEUrl "HALT",3,"TVHOME_RAW/halt3.html")
  (createYAMLfromTVHOMEUrl "HALT",4,"TVHOME_RAW/halt4.html")
  )
